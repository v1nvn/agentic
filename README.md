...
```sh
npx -y @v1nvn/zai@0.27.3        # GLM Coding Plan usage report
npx -y @v1nvn/tokens@0.27.3     # token usage + cache hit rate from local transcripts
npx -y @v1nvn/rm@0.27.3         # last reply → reMarkable (or a file: npx -y @v1nvn/rm@0.27.3 reply.md)
npx -y @v1nvn/md@0.27.3         # last reply → Markdown-Viewer (--view for read-only; or a file: npx -y @v1nvn/md@0.27.3 reply.md)
```
