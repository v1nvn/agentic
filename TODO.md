...
- Ship statusline as plugin 8 + `@v1nvn/statusline-lab` package (trampoline runtime) — HIGH — → progress/statusline-plugin.md — plan seeded 2026-09-12; units defined, nothing built
