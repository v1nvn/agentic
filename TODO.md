...
- Centralize work tracking — todo plugin (rules skill, six verbs, migrate every repo) — HIGH — → progress/todo-plugin.md — U2 landed (glob discovery); next U3 verb skills
