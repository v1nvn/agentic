...
read-only — preview pane only, no edit pane — then report the result.

Run this exactly:

    npx -y @v1nvn/md@0.27.0 --view
...
`UserPromptExpansion` hook normally intercepts `/md:view` and runs this with **no model
