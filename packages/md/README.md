...
```sh
npx -y @v1nvn/md@0.27.0              # editable — both panes
npx -y @v1nvn/md@0.27.0 --view       # read-only — preview pane only
npx -y @v1nvn/md@0.27.0 reply.md
```
...
| Invocation | Does |
|---|---|
| `npx -y @v1nvn/md@0.27.0` | last reply → viewer, edit pane enabled, link copied |
| `npx -y @v1nvn/md@0.27.0 --view` | read-only share |
| `npx -y @v1nvn/md@0.27.0 reply.md` | that file instead of the last reply |
| `npx -y @v1nvn/md@0.27.0 -` | Markdown from stdin |
