...
```sh
npx -y @v1nvn/md@0.27.1              # editable — both panes
npx -y @v1nvn/md@0.27.1 --view       # read-only — preview pane only
npx -y @v1nvn/md@0.27.1 reply.md
```
...
| Invocation | Does |
|---|---|
| `npx -y @v1nvn/md@0.27.1` | last reply → viewer, edit pane enabled, link copied |
| `npx -y @v1nvn/md@0.27.1 --view` | read-only share |
| `npx -y @v1nvn/md@0.27.1 reply.md` | that file instead of the last reply |
| `npx -y @v1nvn/md@0.27.1 -` | Markdown from stdin |
