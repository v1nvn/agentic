...
| Invocation | Does |
|---|---|
| `npx -y @v1nvn/zai@0.23.0` | usage report — models, quota window, remaining balance |
| `npx -y @v1nvn/zai@0.23.0 --auth-token TOKEN` | same, key on the command line (visible in `ps`) |
