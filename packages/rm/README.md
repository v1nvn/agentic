...
```sh
npx -y @v1nvn/rm@0.27.0
npx -y @v1nvn/rm@0.27.0 reply.md
```
...
| Invocation | Does |
|---|---|
| `npx -y @v1nvn/rm@0.27.0` | the previous assistant reply from local transcripts → EPUB on the device |
| `npx -y @v1nvn/rm@0.27.0 reply.md` | that file instead of the last reply |
