...
```sh
npx -y @v1nvn/rm@0.27.1
npx -y @v1nvn/rm@0.27.1 reply.md
```
...
| Invocation | Does |
|---|---|
| `npx -y @v1nvn/rm@0.27.1` | the previous assistant reply from local transcripts → EPUB on the device |
| `npx -y @v1nvn/rm@0.27.1 reply.md` | that file instead of the last reply |
