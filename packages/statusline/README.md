...
npx -y @v1nvn/statusline@0.24.0 configure --model block --bar gauge --fallback=default --dry-run   # preview, write nothing
npx -y @v1nvn/statusline@0.24.0 configure --model block --bar gauge --fallback=default             # the write
