...
npx -y @v1nvn/statusline@0.27.2 configure --model block --bar gauge --fallback=default --dry-run   # preview, write nothing
npx -y @v1nvn/statusline@0.27.2 configure --model block --bar gauge --fallback=default             # the write
