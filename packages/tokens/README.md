...
| Invocation | Does |
|---|---|
| `npx -y @v1nvn/tokens@0.23.0` | per-model table: input/output/cache-write/cache-read tokens, cache hit rate, 24 h window + 7-day daily totals |
